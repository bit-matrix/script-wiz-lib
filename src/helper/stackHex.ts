...
const availableNumber = (hexString: string, byteLenght: number): boolean => {
  ...
  // n = 0x80
  if (byteLenght === 1)
    if (0x00 == numberHex || 0x80 == numberHex) return false;
  ...
  if (byteLenght === 3)
    if (
      (0x000001 <= numberHex && numberHex <= 0x007fff) ||
      (0x800000 <= numberHex && numberHex <= 0x807fff)
    )
      return false;
  ...
  if (byteLenght === 4)
    if (
      (0x00000001 <= numberHex && numberHex <= 0x007fffff) ||
      (0x80000000 <= numberHex && numberHex <= 0x807fffff)
    )
      return false;
