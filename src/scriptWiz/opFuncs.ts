...
export const opFuncs = (
  ...
  if (
    ...
    const addDataArray: WizData[] = [
      WizData.fromNumber(currentOpCode?.output || 0),
    ];
  ...
  if (word === "OP_VERIFY") {
    ...
    const isVerify = flow.flowVerify(
      mainStackDataArray[mainStackDataArray.length - 1]
    );
  ...
  if (word === "OP_TOALTSTACK") {
    ...
    const removeLastSize: number = 1;
    const alt = {
      addData: mainStackDataArray[mainStackDataArrayLength - 1],
      removeLastStackData: false,
    };
    return { main: { addDataArray, removeLastSize }, alt };
  }
  ...
  if (word === "OP_FROMALTSTACK") {
    ...
    const addDataArray: WizData[] = [
      stacks.fromAltStack(stackDataList.alt[stackDataList.alt.length - 1]),
    ];
  ...
  if (word === "OP_2DUP") {
    ...
    const addDataArray: WizData[] = stacks.twoDup(
  ...
  if (word === "OP_2OVER") {
    ...
    const addDataArray: WizData[] = stacks.twoOver(
  ...
  if (word === "OP_IFDUP") {
    ...
    const currentData = stacks.ifDup(
      mainStackDataArray[mainStackDataArrayLength - 1]
    );
  ...
  if (word === "OP_DUP") {
    ...
    const addDataArray: WizData[] = [
      stacks.dup(mainStackDataArray[mainStackDataArrayLength - 1]),
    ];
    const removeLastSize: number = 0;
    const alt = { removeLastStackData: false };
  ...
  if (word === "OP_NIP") {
    ...
    const addDataArray: WizData[] = [
      stacks.nip(mainStackDataArray[mainStackDataArrayLength - 1]),
    ];
    const removeLastSize: number = 2;
    const alt = { removeLastStackData: false };
  ...
  if (word === "OP_OVER") {
    ...
    const addDataArray: WizData[] = [
      stacks.over(mainStackDataArray[mainStackDataArrayLength - 2]),
    ];
    const removeLastSize: number = 0;
    const alt = { removeLastStackData: false };
  ...
  if (word === "OP_SWAP") {
    ...
    const addDataArray: WizData[] = stacks.swap(
      mainStackDataArray[mainStackDataArrayLength - 1],
      mainStackDataArray[mainStackDataArrayLength - 2]
    );
    const removeLastSize: number = 2;
  ...
  if (word === "OP_PICK") {
    ...
    let stackIndex: number | undefined =
      mainStackDataArray[mainStackDataArrayLength - 1].number;
    ...
    const addDataArray: WizData[] = stacks.pick(
      willChangedStackDataArray,
      stackIndex
    );
  ...
  if (word === "OP_ROLL") {
    ...
    const addDataArray: WizData[] = stacks.roll(
      willChangedStackDataArray,
      stackIndex
    );
  ...
  if (word === "OP_TUCK") {
    ...
    const addDataArray: WizData[] = stacks.tuck(
      mainStackDataArray[mainStackDataArrayLength - 2],
      mainStackDataArray[mainStackDataArrayLength - 1]
    );
  ...
  if (word === "OP_SIZE") {
    ...
    const addDataArray: WizData[] = [
      splices.size(mainStackDataArray[mainStackDataArrayLength - 1]),
    ];
    const removeLastSize: number = 0;
    const alt = { removeLastStackData: false };
  ...
  if (word === "OP_INVERT") {
    ...
    const addDataArray: WizData[] = [
      bitwise.invert(mainStackDataArray[mainStackDataArrayLength - 1]),
    ];
    const removeLastSize: number = 0;
    const alt = { removeLastStackData: false };
  ...
  if (word === "OP_1ADD") {
    ...
    const addDataArray: WizData[] = [
      arithmetics.add1(mainStackDataArray[mainStackDataArrayLength - 1]),
    ];
    const removeLastSize: number = 1;
    const alt = { removeLastStackData: false };
  ...
  if (word === "OP_1SUB") {
    ...
    const addDataArray: WizData[] = [
      arithmetics.sub1(mainStackDataArray[mainStackDataArrayLength - 1]),
    ];
    const removeLastSize: number = 1;
    const alt = { removeLastStackData: false };
  ...
  if (word === "OP_NEGATE") {
    ...
    const addDataArray: WizData[] = [
      arithmetics.negate(mainStackDataArray[mainStackDataArrayLength - 1]),
    ];
    const removeLastSize: number = 1;
    const alt = { removeLastStackData: false };
  ...
  if (word === "OP_ABS") {
    ...
    const addDataArray: WizData[] = [
      arithmetics.abs(mainStackDataArray[mainStackDataArrayLength - 1]),
    ];
    const removeLastSize: number = 1;
    const alt = { removeLastStackData: false };
  ...
  if (word === "OP_NOT") {
    ...
    const addDataArray: WizData[] = [
      arithmetics.not(mainStackDataArray[mainStackDataArrayLength - 1]),
    ];
    const removeLastSize: number = 1;
    const alt = { removeLastStackData: false };
  ...
  if (word === "OP_0NOTEQUAL") {
    ...
    const addDataArray: WizData[] = [
      arithmetics.notEqual0(mainStackDataArray[mainStackDataArrayLength - 1]),
    ];
    const removeLastSize: number = 1;
    const alt = { removeLastStackData: false };
  ...
  if (word === "OP_NUMEQUALVERIFY") {
    ...
    const isVerifed: boolean =
      arithmetics.numEqualVerify(
        mainStackDataArray[mainStackDataArrayLength - 2],
        mainStackDataArray[mainStackDataArrayLength - 1]
      ).number === 1;
    const removeLastSize: number = 2;
  ...
  if (word === "OP_SHA1") {
    ...
    const addDataArray: WizData[] = [
      WizData.fromHex(
        crypto.sha1(mainStackDataArray[mainStackDataArrayLength - 1]).toString()
      ),
    ];
    const removeLastSize: number = 1;
    const alt = { removeLastStackData: false };
  ...
  if (word === "OP_SHA256") {
    ...
    const addDataArray: WizData[] = [
      WizData.fromHex(
        crypto
          .sha256(mainStackDataArray[mainStackDataArrayLength - 1])
          .toString()
      ),
    ];
    const removeLastSize: number = 1;
  ...
  if (word === "OP_RIPEMD160") {
    ...
    const addDataArray: WizData[] = [
      WizData.fromHex(
        crypto
          .ripemd160(mainStackDataArray[mainStackDataArrayLength - 1])
          .toString()
      ),
    ];
    const removeLastSize: number = 1;
  ...
  if (word === "OP_HASH160") {
    ...
    const addDataArray: WizData[] = [
      WizData.fromHex(
        crypto
          .hash160(mainStackDataArray[mainStackDataArrayLength - 1])
          .toString()
      ),
    ];
    const removeLastSize: number = 1;
  ...
  if (word === "OP_HASH256") {
    ...
    const addDataArray: WizData[] = [
      WizData.fromHex(
        crypto
          .hash256(mainStackDataArray[mainStackDataArrayLength - 1])
          .toString()
      ),
    ];
    const removeLastSize: number = 1;
  ...
  if (word === "OP_CHECKSIGVERIFY") {
    ...
    const checkSigResult: WizData = crypto.checkSig(
      mainStackDataArray[mainStackDataArrayLength - 2],
      mainStackDataArray[mainStackDataArrayLength - 1]
    );
    const removeLastSize: number = 2;
